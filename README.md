...
```gradle
dependencies {
  implementation 'com.euronovate.mobilesdk:core:1.2.1'
}
```
...
```gradle
dependencies {
 	implementation "com.euronovate.viewer:viewer:1.2.1"
}
```
...
```gradle
dependencies {
  implementation "com.euronovate.digitalsignage:digitalsignage:1.2.1"
}
```
...
```gradle
dependencies {
    implementation "com.euronovate.presenter:presenter:1.2.1"
}
```
...
```gradle
dependencies {
    implementation "com.euronovate.pubsub:pubsub:1.2.1"
}
```
...
```gradle
dependencies {
	implementation "com.euronovate.signaturebox:signaturebox:1.2.1"
}
```
...
```gradle
dependencies {
  implementation "com.euronovate.softserver:softserver:1.2.1"
}
```
