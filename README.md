...
```gradle
dependencies {
 	implementation "com.euronovate.viewer:viewer:1.3.12"
}
```
...
```gradle
dependencies {
    implementation "com.euronovate.pdfmiddleware:pdfMiddleware:1.3.12"
}
```
...
```gradle
dependencies {
    implementation "com.euronovate.presenter:presenter:1.3.12"
}
```
...
```gradle
dependencies {
    implementation "com.euronovate.pubsub:pubsub:1.3.12"
}
```
...
```gradle
dependencies {
	implementation "com.euronovate.signaturebox:signaturebox:1.3.12"
}
```
...
```gradle
dependencies {
  implementation "com.euronovate.bio:bio:1.3.12"
}
```
