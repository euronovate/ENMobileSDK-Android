...
```gradle
dependencies {
  implementation 'com.euronovate.mobilesdk:core:1.2.2'
}
```
...
```gradle
dependencies {
 	implementation "com.euronovate.viewer:viewer:1.2.2"
}
```
...
```gradle
dependencies {
  implementation "com.euronovate.digitalsignage:digitalsignage:1.2.2"
}
```
...
```gradle
dependencies {
    implementation "com.euronovate.pdfmiddleware:pdfMiddleware:1.2.2"
}
```
...
```gradle
dependencies {
    implementation "com.euronovate.pubsub:pubsub:1.2.2"
}
```
...
```gradle
dependencies {
  implementation "com.euronovate.softserver:softserver:1.2.2"
}
```
