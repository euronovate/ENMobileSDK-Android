...
```gradle
dependencies {
 	implementation "com.euronovate.viewer:viewer:1.2.3"
}
```
...
```gradle
dependencies {
    implementation "com.euronovate.presenter:presenter:1.2.3"
}
```
...
```gradle
dependencies {
    implementation "com.euronovate.pubsub:pubsub:1.2.3"
}
```
